namespace FluentValidationPlayground.Rest {
	...
	public static class ServiceLocator {
		...
		private static Func<Type, bool> hasService;

		public static void Initialize(Func<Type, object> GetService, Func<Type, bool> HasService) {
			if (GetService == null) {
				throw new ArgumentNullException("GetService");
			}
			if (HasService == null) {
				throw new ArgumentNullException("HasService");
			}
